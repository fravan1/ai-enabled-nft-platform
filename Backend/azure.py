# importing Azure AI Computer Vision SDK
import azure.ai.vision as sdk

# sourcing image from the images folder, and send it for processing to Microsoft Cognitive API
# store the caption in the metadata.csv file


# Setting up Auth for Microsoft Cognitive API
def authenticate_client():
    url = "https://ethwaterloo.cognitiveservices.azure.com/"
    key = "d08c1ccf661941498a31e3bf14a92202"
    service_options = sdk.VisionServiceOptions(url, key)
    return service_options


# Setting up the Analyzer Options
...
def get_caption(image):
    ...
    service_options = authenticate_client()
    # Get the analyzer options
    analysis_options = get_analyzer_options()

    vision_source = sdk.VisionSource(image)
